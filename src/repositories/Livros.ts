...
export async function repositoryCriarLivro(autor_id:number, titulo:string, sub_titulo:string|null, editora:string, publicado_em:number, edicao:number, formato:string, isbn:string, genero:string): Promise<number | null>{
...
export async function repositoryAtualizarLivro(id:number, autor_id:number, titulo:string, sub_titulo:string|null, editora:string, publicado_em:number, edicao:number, formato:string, isbn:string, genero:string): Promise<number | null> {
